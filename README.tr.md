...
Deskody ilk açılışta **İngilizce** başlar. **Settings → Language → App language** bölümünden **Türkçe** seçebilirsiniz. Türkçe arayüzde bu alan **Ayarlar → Dil → Uygulama dili** olarak görünür.

Dil seçimi hemen kaydedilir; sonraki açılışlarda hatırlanır. Ana pencere ve menü çubuğundaki hızlı kontroller birlikte güncellenir. Dil değiştirmek çalan müziği veya kaydedilmemiş diğer ayarları etkilemez. Kendi kural adlarınız, uygulama adları ve parça bilgileri çevrilmez. Önceki sürümlerde dil seçimi olmayan ayarlar İngilizce ile açılır; mevcut kurallar korunur.

Bu README’nin üstündeki **English / Türkçe** bağlantıları, GitHub’da iki dil arasında geçiş yapar.
