"""Runs the real AppKit menu on the current Space and an external fullscreen Space.
...
print("Native menu: current Space + external fullscreen integration passed.")
